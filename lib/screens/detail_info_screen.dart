...
class DetailInfoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedDetail =
        DUMMY_Details.firstWhere((detail) => detail.id == detailId);
    return Scaffold(
      appBar: AppBar(
              ...
              ListView.builder(
                itemBuilder: (ctx, index) => Card(
                  ...
                  child: Padding(
                    ...
                    child: Text(selectedDetail.ingredients[index]),
                  ),
                ),
                itemCount: selectedDetail.ingredients.length,
              ),
            ),
                ...
                itemBuilder: (ctx, index) => Column(
                  children: <Widget>[
                    ListTile(
                      ...
                      title: Text(
                        selectedDetail.steps[index],
                      ),
                    ),
                    Divider(),
                  ],
                ),
                itemCount: selectedDetail.steps.length,
              ),
            ),
          ],
        ),
